...
<div id="bodyPan">
  ...
  <label></label>
	...
	<div class="Estilo4" id="Layer9">Hora</div>
	<div id="Layer63">
  <label>
...
<div class="Estilo4" id="Layer66">Tarea</div>
<div class="Estilo4" id="Layer67">Estado</div>
<div class="Estilo4" id="Layer68">UO Origen </div>
<div class="Estilo4" id="Layer71">UO Destino </div>
<div class="Estilo4" id="Layer69">Usuario</div>
<div class="Estilo4" id="Layer70">Glosario Seguimiento </div>	
