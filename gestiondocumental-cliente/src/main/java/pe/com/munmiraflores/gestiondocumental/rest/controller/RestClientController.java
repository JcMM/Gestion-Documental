...
import pe.com.munmiraflores.gestiondocumental.domain.PersonasList;
import pe.com.munmiraflores.gestiondocumental.rest.util.Writer;
...
public class RestClientController {
	...
	public String getAll(Model model) {
		...
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(acceptableMediaTypes);
		HttpEntity<Personas> entity = new HttpEntity<Personas>(headers);

		// Send the request as GET
		try {
			ResponseEntity<PersonasList> result = 
					restTemplate.exchange("http://localhost:28080/spring-rest-servidor/agenda/persons",
							HttpMethod.GET, entity, PersonasList.class);
			// Add to model
	...
	public String getPerson(@RequestParam("id") Long id, Model model) {
		...
		// Send the request as GET
		try {
			ResponseEntity<Personas> result = restTemplate.exchange("http://localhost:28080/spring-rest-servidor/agenda/person/{id}", HttpMethod.GET, entity, Personas.class, id);
			// Add to model
	...
	public String getAddPage(Model model) {
		...
		model.addAttribute("personAttribute", new Personas());
	...
	public String addPerson(@ModelAttribute("personAttribute") Personas personas,
						 Model model) {
		...
		HttpEntity<Personas> entity = new HttpEntity<Personas>(personas, headers);

		// Send the request as POST
		try {
			ResponseEntity<Personas> result = restTemplate.exchange("http://localhost:28080/spring-rest-servidor/agenda/person", HttpMethod.POST, entity, Personas.class);
		} catch (Exception e) {
			logger.error(e);
		}
	...
	public String updatePerson(@ModelAttribute("personAttribute") Personas personas,
